...
// This test can be excuted using awsAuthDetails, however, there are  more policies listed by  
    ...
    function handleFile(err, data) {
       ...
       // console.log(obj.length)
        ...
        function handleFile2(err, data) {
                ...
                console.log("1- Number of elements for " + fileName2 + ": " + array2_name.length)
